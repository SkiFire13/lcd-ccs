...
inv-conv-trans' {indet _} (indet s t) | [ refl ] | [ refl ]
  with p' , refl , t' ← inv-conv-trans' t
  = p' , refl , indet s t'
inv-conv-trans' {const _ _} (const t) | [ refl ] | [ refl ]
  with p' , refl , t' ← inv-conv-trans' t
  = p' , refl , const t'
...
inv-conv-trans' {hide f _} {a} (hide z t) | [ refl ] | [ refl ]
...
inv-conv-trans' {if true _} t | [ refl ] | [ refl ]
  with p' , refl , t' ← inv-conv-trans' t
  = p' , refl , if t'
