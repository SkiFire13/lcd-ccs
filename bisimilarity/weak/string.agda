...
StringBisimulationProperty R p q = ∀ {a p'} → WeakTrans p a p' → ∃[ q' ] (WeakTrans q a q' × R p' q')
...
p-to-q-tau : ∀ {p q p'} → p ≈ q → TauSeq p p' → ∃[ q' ] (WeakTrans q tau q' × p' ≈ q')
...
p-to-q-split : ∀ {p1 p2 p3 p4 q a} → p1 ≈ q → TauSeq p1 p2 → Trans p2 a p3 → TauSeq p3 p4
...
p-to-q-weak : ∀ {p q a p'} → p ≈ q → WeakTrans p a p' → ∃[ q' ] (WeakTrans q a q' × p' ≈ q')
